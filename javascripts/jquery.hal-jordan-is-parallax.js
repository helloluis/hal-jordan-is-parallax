  ...
  */
  ...
  $.Parallax.prototype  = {
    ...
    _create : function( options ) {
      ...
      // when a touch gesture is initiated, we store the initial coordinates here.
      // obviously this is only relevant when the browser is iPad based, and iPad support is enabled
      this.touch_y      = 0;
      this.touch_x      = 0;
